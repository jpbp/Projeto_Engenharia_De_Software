...
$aux = $fDAO->buscarFuncionarioFormulario($f1,$con->getLink());
    ...
    <main class="principal">
        <div class="row justify-content-center mb-5">
            <div class="col-sm-12 col-md-10 col-lg-8">
                <form method="POST" action="../Controller/controller_AlterarFuncionario.php">
                    <div class="form-row">
                    ...
                    <div class="form-row">
                        <div class="form-group col-sm-8">
                            <label for="inputComplemento">Senha</label>
                            <input type="text" class="form-control" name="senha" id="inputComplemento" value=<?php echo $senha ?>>
                        </div>
                    </div>
                    <div class="form-row">
